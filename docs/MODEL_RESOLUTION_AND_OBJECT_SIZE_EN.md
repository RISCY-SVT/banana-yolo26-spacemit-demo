...
|---|---:|---:|
| COCO small, area below 32² | 15,264 | 0.1794 |
| COCO medium, 32² to 96² | 12,392 | 0.5082 |
| COCO large, at least 96² | 8,679 | 0.7991 |
...
wall-poster view produced 132 accepted `person` observations in the three
selected runs. Their smallest shorter side was 348.886719 pixels, and all fell
in the `>=96` bin. These are repeated detector observations without independently
staged ground truth, measured distance, or scene variation, so they do not
establish a reliability threshold. The requested three-scene/five-class study
could not be performed remotely; `resolution_camera_observations.tsv` preserves
the bounded evidence instead of inventing scenes or classes.
