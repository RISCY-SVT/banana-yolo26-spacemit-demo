...
ram_dir="/dev/shm/y26-stage57-abba-$label"
...
# Frozen Stage56 operator control. Candidate env files may alter only Stage57 flags.
...
for ((cycle = 0; cycle < cycles; ++cycle)); do
    ...
    for position in 0 1; do
        ...
        unset Y26_STAGE57_E2C5 Y26_STAGE57_ATTENTION_MATMUL_C8 \
            Y26_STAGE57_ATTENTION_SOFTMAX_CACHE Y26_STAGE57_HEAD_BUCKET \
            Y26_STAGE57_RGB_COPY_RVV || true
