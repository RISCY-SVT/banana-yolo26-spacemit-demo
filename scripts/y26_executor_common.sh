...
Y26_RELEASE_ROOT=${Y26_RELEASE_ROOT:-/data/releases/banana-yolo26-k1x-int8-executor/0.9.1-stage58-camera-handoff}
Y26_BOARD_TARGET=${Y26_BOARD_TARGET:-svt@banana}
Y26_BOARD_RELEASE_ROOT=${Y26_BOARD_RELEASE_ROOT:-/data/y26-k1x-int8-executor/0.9.1}
